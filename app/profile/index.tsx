  ...
  return (
    <View style={[{ flex: 1, backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <Text style={[styles.buttonText, { color: isDark ? colors.background : colors.white }]}>Edit Profile</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.button, styles.buttonSecondary, { borderColor: colors.primary, backgroundColor: 'transparent', marginBottom: Spacing.xl }]}
          onPress={handleExportCV}
          accessibilityRole="button"
          accessibilityLabel="Export CV as PDF"
        >
      ...
      >
        <View style={[styles.modalContainer, { backgroundColor: colors.background }]}>
          ...
          <View style={[styles.modalFooter, { backgroundColor: colors.surface, borderTopColor: colors.border }]}>
            <TouchableOpacity
              style={[styles.button, styles.buttonSecondary, { flex: 1, borderColor: colors.border, backgroundColor: 'transparent' }]}
              onPress={() => setShowPreview(false)}
              accessibilityRole="button"
            ...
            <View style={{ flex: 1, marginLeft: Spacing.md }}>
              ...
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel="Confirm Export PDF"
                accessibilityState={{ disabled: isExporting }}
              >
                {isExporting ? (
                  <ActivityIndicator color={isDark ? colors.background : colors.white} />
                ) : (
                  <Text style={[styles.buttonText, { color: isDark ? colors.background : colors.white }]}>Export PDF</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    alignItems: 'center',
    marginTop: Spacing.xl + 20, // avoid status bar
