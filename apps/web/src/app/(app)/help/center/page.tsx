          ...
          <div className="mb-14 text-center max-w-3xl mx-auto">
            ...
            <div className="relative max-w-2xl mx-auto mt-8">
              ...
              <input 
                ...
                className="w-full pl-12 pr-6 py-4 md:py-5 bg-surface border border-border rounded-full text-[16px] text-text-primary shadow-sm focus:outline-none focus:border-[#007AFF] focus:ring-4 focus:ring-[#007AFF]/10 transition-all placeholder:text-text-secondary/70"
              />
            </div>
          </div>
                  ...
                  {category.articles.map((article, i) => (
                    <li key={i}>
                      <Link href="#" className="flex items-center text-[15px] font-medium text-text-primary hover:text-[#007AFF] transition-colors group/link">
                        {article}
                        <ChevronRight size={16} className="ml-1 opacity-0 -translate-x-2 group-hover/link:opacity-100 group-hover/link:translate-x-0 transition-all text-[#007AFF]" />
                      </Link>
                    </li>
                  ))}
                </ul>
