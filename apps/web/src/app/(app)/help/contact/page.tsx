                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <select required defaultValue="" className="w-full px-4 py-3.5 bg-background border border-border rounded-xl text-[15px] text-text-primary focus:outline-none focus:border-[#007AFF] focus:ring-1 focus:ring-[#007AFF] transition-all appearance-none cursor-pointer">
