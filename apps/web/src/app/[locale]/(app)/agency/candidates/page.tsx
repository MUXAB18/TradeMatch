    ...
    <div className="max-w-[1200px] mx-auto px-6 py-10">
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm mb-8 flex flex-col md:flex-row gap-4">
        <div className="flex-1 relative">
          <Briefcase className="absolute start-4 top-1/2 -translate-y-1/2 text-gray-400" size={20} />
          <select 
            className="w-full ps-12 pe-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
            value={tradeFilter}
        ...
        <div className="flex-1 relative">
          <MapPin className="absolute start-4 top-1/2 -translate-y-1/2 text-gray-400" size={20} />
          <input 
            type="text"
            placeholder="Any Location (e.g. Dubai)"
            className="w-full ps-12 pe-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={countryFilter}
