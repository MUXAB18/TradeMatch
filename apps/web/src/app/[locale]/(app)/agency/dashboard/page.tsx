  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-10">
      <header className="mb-10">
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2">{t('dashboard_title')}</h1>
        <p className="text-gray-500">{t('dashboard_welcome')}, {profile?.agencyProfile?.companyName || profile?.name || 'Recruiter'}</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-bold text-gray-500 uppercase">{t('shortlisted')}</p>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-bold text-gray-500 uppercase">{t('active_jobs')}</p>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-sm font-bold text-gray-500 uppercase">{t('messages')}</p>
      ...
      <section>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-extrabold text-gray-900">{t('recent_candidates')}</h2>
          <Link href="/agency/candidates" className="text-blue-600 font-bold hover:underline">{t('view_all')}</Link>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
          <table className="w-full text-start">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="py-4 px-6 font-bold text-gray-500 text-sm uppercase tracking-wide">{t('candidate')}</th>
                <th className="py-4 px-6 font-bold text-gray-500 text-sm uppercase tracking-wide">{t('trade')}</th>
                <th className="py-4 px-6 font-bold text-gray-500 text-sm uppercase tracking-wide">{t('location')}</th>
                <th className="py-4 px-6 font-bold text-gray-500 text-sm uppercase tracking-wide">{t('verification')}</th>
