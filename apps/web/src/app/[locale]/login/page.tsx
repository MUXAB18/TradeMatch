  ...
  return (
    <div className="grid min-h-screen w-full lg:grid-cols-[45%_55%] xl:grid-cols-2">
      ...
      <div className="hidden lg:flex relative bg-gradient-to-br from-[#0055FF] to-[#007AFF] flex-col justify-between p-8 lg:p-12 xl:p-16 overflow-hidden">
        ...
        <div className="absolute bottom-0 start-0 w-[600px] h-[600px] bg-secondary/20 rounded-full blur-3xl -translate-x-1/4 translate-y-1/4"></div>
        ...
        <div className="relative z-10 w-full pe-8 mb-12 mt-8">
          ...
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight">
            {t('hero_title_1')} <br />
            <span className="text-white/80">{t('hero_title_2')}</span> <br />
            {t('hero_title_3')}
          </h1>
        ...
        <div className="relative z-10 flex items-center gap-4 mt-auto">
          ...
          <p className="text-white/90 text-sm font-medium">{t('trusted_by')}</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex flex-col mb-8">
            ...
            <p className="text-sm text-gray-500 font-medium">
              {authMethod === 'email' ? t('login_subtitle') : 'Enter your phone number to get started.'}
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3 mb-6">
              ...
              <div className="relative h-14 border border-gray-200 bg-white shadow-sm rounded-xl px-4 flex flex-col justify-center transition-all focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/10">
                ...
                <input
                  ...
                  className="w-full text-[15px] font-semibold text-gray-900 outline-none bg-transparent placeholder-gray-300 pe-10"
                  placeholder="••••••••"
          ...
          <div className="flex justify-center items-center mt-8">
            <span className="text-[15px] font-medium text-gray-500 me-2">
              {t('no_account')}
            </span>
