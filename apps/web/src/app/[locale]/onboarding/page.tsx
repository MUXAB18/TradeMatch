            ...
            <div className="space-y-3 mb-8">
              {EXPERIENCE_OPTIONS.map(opt => (
                <button
                  ...
                  className={`w-full h-14 px-6 rounded-xl border-2 transition-all flex items-center text-start ${
                ...
                >
                  ...
                  {yearsExperience === opt.value && (
                    <div className="ms-auto w-5 h-5 bg-[#007AFF] rounded-full flex items-center justify-center">
